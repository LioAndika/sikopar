...
<head>
    ...
    <title>Profil Gereja - Paroki Santo Yoseph Sidareja</title>
    ...
    <style>
        ...
        .dropdown-menu.active {
            ...
            max-height: 180px; /* Cukup tinggi untuk menampung semua item, disesuaikan untuk item baru */
            opacity: 1;
...
<body class="bg-gray-100 antialiased">
    ...
    <nav class="bg-blue-900 p-4 text-white flex justify-between items-center relative z-10 shadow-md">
        ...
        <div class="md:hidden flex items-center space-x-2 relative navbar-mobile-nav flex-grow justify-end">
            ...
            <div id="mobile-dropdown-menu" class="dropdown-menu" role="menu">
                ...
                {{-- Tambahkan link Informasi ke dropdown mobile --}}
                <a href="{{ route('informasi') }}" class="
                    dropdown-item
    ...
    <main class="container mx-auto p-8 bg-white shadow-lg rounded-lg my-8">
        <h1 class="text-3xl font-bold text-blue-800 mb-6">Profil Gereja Paroki Santo Yoseph Sidareja</h1>

        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-blue-700 mb-4">Sejarah Singkat</h2>
            <p class="text-gray-700 leading-relaxed mb-4">
                Gereja Katolik Paroki Santo Yoseph Sidareja memiliki sejarah yang panjang dan kaya, berawal dari komunitas umat Katolik yang kecil di wilayah Sidareja dan sekitarnya. Seiring berjalannya waktu, jumlah umat bertambah, memunculkan kebutuhan akan tempat ibadah yang permanen dan struktur paroki yang lebih terorganisir.
            </p>
            <p class="text-gray-700 leading-relaxed">
                Pembangunan gereja pertama dimulai pada tahun [Tahun Mulai Pembangunan] dan diresmikan pada [Tahun Peresmian]. Sejak saat itu, Gereja Santo Yoseph Sidareja telah menjadi pusat spiritual dan komunitas bagi umat Katolik di wilayah ini, terus berkembang dan melayani kebutuhan rohani umatnya.
            </p>
        </section>

        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-blue-700 mb-4">Visi & Misi</h2>
            <h3 class="text-xl font-medium text-blue-600 mb-2">Visi:</h3>
            <p class="text-gray-700 leading-relaxed mb-4">
                Menjadi komunitas umat beriman yang bertumbuh dalam kasih Kristus, melayani sesama, dan mewujudkan Kerajaan Allah di dunia.
            </p>
            <h3 class="text-xl font-medium text-blue-600 mb-2">Misi:</h3>
            <ul class="list-disc list-inside text-gray-700 leading-relaxed pl-4">
                <li>Meningkatkan kualitas iman umat melalui liturgi yang hidup, katekese yang mendalam, dan doa bersama.</li>
                <li>Mendorong partisipasi aktif umat dalam kehidupan menggereja dan bermasyarakat.</li>
                <li>Mengembangkan pelayanan kasih dan kepedulian sosial bagi mereka yang membutuhkan.</li>
                <li>Memperkuat persaudaraan sejati di antara umat dan dengan masyarakat luas.</li>
            </ul>
        </section>

        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-blue-700 mb-4">Informasi Tambahan</h2>
            <p class="text-gray-700 leading-relaxed">
                Paroki Santo Yoseph Sidareja terus berupaya menjadi terang dan garam dunia melalui berbagai kegiatan rohani dan sosial. Kami mengundang Anda untuk bergabung dalam persekutuan kami.
            </p>
            <img src="{{ asset('images/tentang_gereja_card.jpg') }}" alt="Gereja Santo Yoseph Sidareja" class="w-full md:w-2/3 lg:w-1/2 mx-auto mt-6 rounded-lg shadow-md">
        </section>
