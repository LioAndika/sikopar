...
<head>
    ...
    <title>Informasi - Paroki Santo Yoseph Sidareja</title>
    ...
    <style>
        ...
        .info-section h2 {
            ...
            border-bottom: 2px solid #3182ce; /* Blue underline for headings */
...
<body class="bg-gray-100 antialiased">
    ...
    <nav class="bg-blue-900 p-4 text-white flex justify-between items-center relative z-10 shadow-md">
        ...
        <div class="hidden md:flex items-center space-x-6 navbar-desktop-nav">
            ...
            <a href="{{ route('galeri') }}" class="
                ...
                hover:text-yellow-300 transition-colors duration-200 focus:text-yellow-300 focus:outline-none
            ">Galeri</a>
            {{-- Link Informasi dipindahkan ke kanan Galeri dan diberi style aktif --}}
        ...
        <div class="md:hidden flex items-center space-x-2 relative navbar-mobile-nav flex-grow justify-end">
            ...
            <div id="mobile-dropdown-menu" class="dropdown-menu" role="menu">
                ...
                {{-- Link Informasi dipindahkan ke kanan Galeri untuk mobile dan diberi style aktif --}}
                <a href="{{ route('informasi') }}" class="
                    dropdown-item
    ...
    <main class="container mx-auto p-8 bg-white shadow-lg rounded-lg my-8">
        <h1 class="text-3xl font-bold text-blue-800 mb-6 text-center">Informasi Penting Paroki</h1>

        <section class="info-section">
            <h2 class="text-2xl font-semibold text-blue-700 mb-4">Jadwal Misa</h2>
            <div class="misa-times bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-200">
                <div class="misa-entry">
                    <h5 class="misa-day font-medium">Senin-Jumat</h5>
                    <h5 class="misa-time font-medium">05 . 30 WIB</h5>
                </div>
                <div class="misa-entry">
                    <h5 class="misa-day font-medium">Sabtu</h5>
                    <h5 class="misa-time font-medium">18 . 00 WIB</h5>
                </div>
                <div class="misa-entry">
                    <h5 class="misa-day font-medium">Minggu</h5>
                    <h5 class="misa-time font-medium">07 . 00 WIB</h5>
                </div>
            </div>
            <p class="text-gray-600 mt-3 text-sm italic">
                Perubahan jadwal akan diumumkan melalui pengumuman paroki.
            </p>
        </section>

        <section class="info-section">
            <h2 class="text-2xl font-semibold text-blue-700 mb-4">Pengumuman Paroki</h2>
            <div class="space-y-4">
                <div class="bg-yellow-50 p-4 rounded-lg shadow-sm border border-yellow-200">
                    <h3 class="text-xl font-medium text-yellow-800 mb-2">Pengumuman: Program Doa Bersama Lingkungan</h3>
                    <p class="text-gray-700 mb-2">
                        Seluruh umat diajak untuk mengikuti program doa bersama di lingkungan masing-masing setiap hari Rabu malam. Silakan hubungi ketua lingkungan Anda untuk informasi lebih lanjut mengenai jadwal dan lokasi.
                    </p>
                    <p class="text-gray-600 text-sm">Tanggal Pengumuman: 20 Juli 2025</p>
                </div>
                <div class="bg-yellow-50 p-4 rounded-lg shadow-sm border border-yellow-200">
                    <h3 class="text-xl font-medium text-yellow-800 mb-2">Pemberitahuan: Pelatihan Koor Baru</h3>
                    <p class="text-gray-700 mb-2">
                        Bagi umat yang memiliki talenta dalam menyanyi dan ingin melayani dalam koor gereja, akan diadakan pelatihan koor baru setiap hari Sabtu sore pukul 16.00 WIB di Aula Paroki. Mari bergabung!
                    </p>
                    <p class="text-gray-600 text-sm">Tanggal Pengumuman: 15 Juli 2025</p>
                </div>
                {{-- Tambahkan lebih banyak pengumuman di sini --}}
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm border border-gray-200 text-gray-700 italic">
                    <p>Belum ada pengumuman terbaru saat ini. Mohon pantau halaman ini secara berkala.</p>
                </div>
            </div>
        </section>
