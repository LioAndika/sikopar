...
<head>
    ...
    <title>Kegiatan & Agenda - Paroki Santo Yoseph Sidareja</title>
    @vite('resources/css/app.css')
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700&display=swap" rel="stylesheet">
    <style>
        body { font-family: 'Poppins', sans-serif; }

        /* Gaya untuk dropdown menu mobile */
        .dropdown-menu {
        ...
        .dropdown-menu.active {
            ...
            max-height: 200px; /* Cukup tinggi untuk menampung semua item, disesuaikan untuk item 'Informasi' */
            opacity: 1;
        ...
        .dropdown-item:hover, .dropdown-item:focus { /* Tambahkan focus state */
        ...
        .mobile-dropdown-toggle {
            ...
            /* Tambahkan focus ring untuk aksesibilitas keyboard */
...
<body class="bg-gray-100 antialiased">
    ...
    <nav class="bg-blue-900 p-4 text-white flex justify-between items-center relative z-10 shadow-md">
        ...
        <div class="hidden md:flex items-center space-x-6 navbar-desktop-nav">
            ...
            <a href="{{ route('galeri') }}" class="
                ...
                hover:text-yellow-300 transition-colors duration-200 focus:text-yellow-300 focus:outline-none
            ">Galeri</a>
            <a href="{{ route('informasi') }}" class=" {{-- Tautan Informasi dipindahkan --}}
        ...
        <div class="md:hidden flex items-center space-x-2 relative navbar-mobile-nav flex-grow justify-end">
            ...
            <div id="mobile-dropdown-menu" class="dropdown-menu" role="menu">
                ...
                <a href="{{ route('informasi') }}" class=" {{-- Item Informasi dipindahkan --}}
                    dropdown-item
    ...
    <main class="container mx-auto p-8 bg-white shadow-lg rounded-lg my-8">
        <h1 class="text-3xl font-bold text-blue-800 mb-6">Kegiatan & Agenda Paroki</h1>

        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-blue-700 mb-4">Agenda Mendatang</h2>
            <div class="space-y-4">
                <div class="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-200">
                    <h3 class="text-xl font-medium text-blue-800 mb-1">Misa Jumat Pertama</h3>
                    <p class="text-gray-700 mb-1">Tanggal: 5 Juli 2025</p>
                    <p class="text-gray-700 mb-2">Waktu: 18.00 WIB</p>
                    <p class="text-gray-600 text-sm">Bertempat di Gereja Paroki Santo Yoseph Sidareja. Mari hadir dalam Ekaristi khusus ini.</p>
                </div>
                <div class="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-200">
                    <h3 class="text-xl font-medium text-blue-800 mb-1">Pertemuan Lingkungan St. Petrus</h3>
                    <p class="text-gray-700 mb-1">Tanggal: 12 Juli 2025</p>
                    <p class="text-gray-700 mb-2">Waktu: 19.00 WIB</p>
                    <p class="text-gray-600 text-sm">Agenda: Pembahasan persiapan Peringatan HUT Paroki. Lokasi akan diumumkan lebih lanjut oleh Ketua Lingkungan.</p>
                </div>
                <div class="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-200">
                    <h3 class="text-xl font-medium text-blue-800 mb-1">Rekoleksi OMK Paroki</h3>
                    <p class="text-gray-700 mb-1">Tanggal: 20 Juli 2025</p>
                    <p class="text-gray-700 mb-2">Waktu: 09.00 - 15.00 WIB</p>
                    <p class="text-gray-600 text-sm">Tema: "Bertumbuh dalam Iman di Era Digital". Peserta diharapkan mendaftar melalui koordinator OMK.</p>
                </div>
            </div>
            <p class="text-gray-600 mt-4 text-sm italic">
                Agenda dapat berubah sewaktu-waktu. Mohon pantau pengumuman lebih lanjut.
            </p>
        </section>

        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-blue-700 mb-4">Kegiatan Rutin</h2>
            <ul class="list-disc list-inside text-gray-700 leading-relaxed pl-4">
                <li><strong class="font-semibold">Misa Harian:</strong> Senin-Jumat pukul 05.30 WIB</li>
                <li><strong class="font-semibold">Misa Sabtu Sore:</strong> Pukul 18.00 WIB</li>
                <li><strong class="font-semibold">Misa Minggu Pagi:</strong> Pukul 07.00 WIB</li>
                <li><strong class="font-semibold">Doa Rosario Bersama:</strong> Setiap hari Selasa pukul 17.00 WIB (di Gereja)</li>
                <li><strong class="font-semibold">Pendalaman Kitab Suci:</strong> Setiap hari Kamis pukul 19.00 WIB (di Aula Paroki)</li>
            </ul>
        </section>
        ...
        <div class="container mx-auto px-6 md:px-10 grid grid-cols-1 md:grid-cols-4 gap-8 footer-grid">
            ...
            <div>
                ...
                <ul class="text-gray-300">
                    ...
                    <li class="mb-2"><a href="{{ route('informasi') }}" class="hover:text-white transition-colors duration-200 focus:text-white focus:outline-none">Informasi</a></li> {{-- Informasi di Footer dipindahkan --}}
                </ul>
            </div>
        </div>
