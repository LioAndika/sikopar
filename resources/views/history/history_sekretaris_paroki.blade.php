...
<head>
    ...
    <title>Riwayat Laporan Kolekte Final - Sekretaris Paroki</title>
    ...
    <div id="sidebar" class="sidebar-container flex-none w-full md:w-64 pb-4 md:pb-0 shadow-lg z-10 md:relative">
       ...
       <nav class="mt-4">
            ...
            <a href="{{ route('sekretaris-paroki.laporan.final') }}" class="sidebar-item {{ Request::routeIs('sekretaris-paroki.laporan.final') ? 'active' : '' }}">
             ...
             <a href="{{ route('sekretaris-paroki.laporan.history.sekretaris-paroki') }}" class="sidebar-item {{ Request::routeIs('sekretaris-paroki.laporan.history.sekretaris-paroki') ? 'active' : '' }}">
