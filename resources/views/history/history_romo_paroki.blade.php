...
<head>
    ...
    <title>Riwayat Laporan Kolekte Final - Romo Paroki</title>
  ...
  {{-- Sidebar Romo Paroki --}}
    ...
    <div class="flex-grow p-6 md:p-10 main-content">
        ...
        <div class="bg-white p-4 md:p-8 rounded-xl shadow-lg mb-8 card-hover-effect">
            ...
            <form action="{{ route('romo-paroki.laporan.history.romo-paroki') }}" method="GET" class="mb-6 bg-gray-50 p-4 rounded-lg shadow-inner grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 items-end filter-form-grid print-hidden">
                <div>
                ...
                <div class="col-span-full flex flex-col md:flex-row justify-end space-y-2 md:space-y-0 md:space-x-2 mt-4 filter-buttons">
                    ...
                    <a href="{{ route('romo-paroki.laporan.history.romo-paroki') }}" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
